...
- [RADIO_SETUP.md](RADIO_SETUP.md) — путь Meshtastic (другой носитель,
  экспериментальный): прошивка, регион, канал сегмента, профиль и проверка.
- [RADIO_STATUS.md](RADIO_STATUS.md) — инженерный снимок дня работы с
  Meshtastic-платами (2026-08-02). Рабочий документ, не руководство.
