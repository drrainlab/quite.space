...
func gatewayAdvice(g gatewayResp) []string {
	...
	case !g.Radio.Attached:
		...
		out = append(out, "No radio is attached. Connect a Meshtastic node "+
			"over USB or WiFi and attach it — until then this device can only "+
			"reach people over the internet or the local network.")
