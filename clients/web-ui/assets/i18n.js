...
const I18N = {
  en: {
    ...
    'link.play': 'play',
    'link.playAsk': 'Playing loads the player from {site} — they will see this device.',
    'link.playYes': 'Watch',
    'link.playNo': 'Not now',
    'conv.today': 'Today',
    'conv.yesterday': 'Yesterday',
    'ui.dev.pending': '{n} space(s) not on this device yet — offered via',
    'ui.dev.guessed': 'guessed',
    'ui.dev.refusals': 'Grants from your other devices were refused here:',
    'knock.ask': 'ask to talk',
    'knock.prompt': 'One line for {name} — why you are asking. They can say no, and you will be told once.',
    'knock.asked': '{name} was asked. Nothing opens until they answer.',
    'knock.somebody': 'somebody',
    'knock.aSharedRoom': 'a room you share',
    'knock.wants': '{who} asks for a conversation · you meet in {via}',
    'knock.letIn': 'open it',
  ...
  ru: {
    ...
    'link.play': 'смотреть',
    'link.playAsk': 'Проигрывание загрузит плеер с {site} — он увидит это устройство.',
    'link.playYes': 'Смотреть',
    'link.playNo': 'Не сейчас',
    'conv.today': 'Сегодня',
    'conv.yesterday': 'Вчера',
    'ui.dev.pending': '{n} пространств(а) ещё не дошли до этого устройства — предложено через',
    'ui.dev.guessed': 'наугад',
    'ui.dev.refusals': 'Гранты с ваших других устройств здесь отклонены:',
    'knock.ask': 'написать',
    'knock.prompt': 'Одна строка для {name} — зачем вы пишете. Человек может отказать, и вам скажут об этом один раз.',
    'knock.asked': '{name} спросили. Пока не ответят, ничего не откроется.',
    'knock.somebody': 'кто-то',
    'knock.aSharedRoom': 'общей комнате',
    'knock.wants': '{who} просит о разговоре · вы вместе в {via}',
    'knock.letIn': 'открыть',
