...
const I18N = {
  en: {
    ...
    'field.marker_kind_prompt': 'Marker kind ({kinds}):',
    'field.marker_text_prompt': 'Label (optional):',
    'field.marker_ttl_prompt': 'Active for how many hours? (empty = timeless)',
  ...
  ru: {
    ...
    'field.marker_kind_prompt': 'Тип маркера ({kinds}):',
    'field.marker_text_prompt': 'Подпись (необязательно):',
    'field.marker_ttl_prompt': 'Активен сколько часов? (пусто = бессрочно)',
