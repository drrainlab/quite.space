...
const I18N = {
  en: {
    ...
    'ui.wiz.next': 'next',
    'ui.wiz.presenceHint': 'custom presence states (comma separated, optional — they may not impersonate system properties like online/verified/delivered):',
    'ui.wiz.presencePh': 'mixing_a_track, reading_not_replying',
  ...
  ru: {
    ...
    'ui.wiz.next': 'дальше',
    'ui.wiz.presenceHint': 'свои состояния присутствия (через запятую, необязательно — они не могут выдавать себя за системные свойства вроде online/verified/delivered):',
    'ui.wiz.presencePh': 'свожу_трек, читаю_не_отвечаю',
