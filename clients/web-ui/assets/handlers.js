...
const UI_HANDLERS = [
  ...
  /*   9 retired  */ null, // view tabs are built by spacenav.js now
  /*  10 retired  */ null,
  /*  11 retired  */ null,
  ...
  /* 256 click    */ (event, el) => { SKYDRAW.start(); },
  /* 257 click    */ (event, el) => { SKYDRAW.setBright(3); },
  /* 258 click    */ (event, el) => { SKYDRAW.setBright(2); },
  /* 259 click    */ (event, el) => { SKYDRAW.setBright(1); },
  /* 260 click    */ (event, el) => { SKYDRAW.undo(); },
  /* 261 click    */ (event, el) => { SKYDRAW.closeSky(); },
  /* 262 click    */ (event, el) => { SKYDRAW.play(); },
  /* 263 click    */ (event, el) => { hubIntent('space'); },
  /* 264 click    */ (event, el) => { hubIntent('new'); },
  /* 265 click    */ (event, el) => { hubCarrier('link'); },
  /* 266 click    */ (event, el) => { hubCarrier('qr'); },
  /* 267 click    */ (event, el) => { hubCarrier('sound'); },
  /* 268 click    */ (event, el) => { dlgMe.close(); hubOpen('new'); },
  ...
  /* 281 click    */ (event, el) => { viewerStep(-1); },
  /* 282 click    */ (event, el) => { viewerStep(1); },
];
